...
// Carte réservation — ❌ SUPPRIMÉ : infos paiement plateforme
// ✅ AJOUTÉ : bouton contacter + info paiement direct
const ReservationCard = ({
  ...
  <div className={`bg-white rounded-xl shadow-sm border-l-4 p-5
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-yellow-600 mt-0.5">
            📱 {r.tutorPhone} (MTN MoMo ou Orange Money)
          </p>
        </div>
    ...
    <div className="flex gap-2">
      ...
      {/* Contacter — disponible pour tous les statuts actifs */}
